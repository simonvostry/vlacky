      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_300px]">
        ...
        <div>
          <div className="rounded-lg border border-gray-200 p-6">
            ...
            {vehicle.dccAddress && (
              <div className="mt-4 inline-flex items-center gap-2 rounded-lg bg-blue-50 px-4 py-2">
                <span className="text-sm text-blue-600">DCC adresa:</span>
                <span className="font-mono text-xl font-bold text-blue-900">{vehicle.dccAddress}</span>
              </div>
            )}
            ...
            <div className="mt-4">
              <Link
                href={`/lokomotivy/${vehicle.id}/upravit`}
