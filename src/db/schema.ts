...
export const vehicles = sqliteTable("vehicles", {
  ...
  hasSoundDecoder: integer("has_sound_decoder", { mode: "boolean" }).notNull().default(false),
  hasSpeaker: integer("has_speaker", { mode: "boolean" }).notNull().default(false),
  isWeathered: integer("is_weathered", { mode: "boolean" }).notNull().default(false),
