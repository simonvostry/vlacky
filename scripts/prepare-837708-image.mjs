// Export the reviewed 837708 livery without replacing the older 837715 artwork.
import sharp from 'sharp';
import { readFile, writeFile } from 'node:fs/promises';
const master = 'output/freight-837708/master.png';
...
// Fleischmann 2021 catalog: 124 mm in N × 160 = 19.84 m equivalent; same scale as 837715.
const width = 198;
...
const source = '/img/catalog/cdc-rils-gray-modern-logo.png';
const enhanced = '/img/enhanced/cdc-rils-gray-modern-logo-4x.webp';
const zoom = '/img/zoom/cdc-rils-gray-modern-logo.webp';
...
await writeFile('output/freight-837708/export.json', JSON.stringify({ source, enhanced, zoom, width, height, crop }, null, 2) + '\n');
