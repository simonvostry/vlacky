// Export the photographed turquoise/cream Bmo as a distinct catalog livery.
import sharp from 'sharp';
import { readFile, writeFile } from 'node:fs/promises';
const exports = [];
for (const key of ['bmo-turquoise-cream']) {
const master = 'output/doubledeck-photo-210608/master.png';
...
const source = `/img/catalog/cd-${key}-v1.png`;
const enhanced = `/img/enhanced/cd-${key}-v1-4x.webp`;
const zoom = `/img/zoom/cd-${key}-v1.webp`;
...
await writeFile('output/doubledeck-photo-210608/exports.json', JSON.stringify(exports, null, 2) + '\n');
