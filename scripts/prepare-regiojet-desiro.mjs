...
const master = 'output/desiro-regiojet/regiojet-642-master.png';
const source = '/img/catalog/642-regiojet-ai.png';
const target = '/img/enhanced/642-regiojet-ai-4x.webp';
