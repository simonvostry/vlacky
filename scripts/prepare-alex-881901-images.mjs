// Export the two distinct liveries in Fleischmann 881901; two Bmz pieces share artwork.
import sharp from 'sharp';
import { readFile, writeFile } from 'node:fs/promises';
const exports = [];
for (const key of ['bmz', 'abbmdz']) {
const master = `output/alex-881901/${key}-master.png`;
...
// Fleischmann 2020 catalog: 495 mm for three coaches, each 165 mm × 160 = 26.4 m.
const width = 264;
...
const source = `/img/catalog/dlb-${key}-alex-881901.png`;
const enhanced = `/img/enhanced/dlb-${key}-alex-881901-4x.webp`;
const zoom = `/img/zoom/dlb-${key}-alex-881901.webp`;
...
await writeFile('output/alex-881901/exports.json', JSON.stringify(exports, null, 2) + '\n');
