// Export Fleischmann 845414 at the common 10 native px per prototype metre.
import sharp from 'sharp';
import { readFile, writeFile } from 'node:fs/promises';
const exports = [];
for (const key of ['db-tadgs-845414']) {
const master = 'output/freight-845414/master.png';
...
const source = `/img/catalog/${key}-v1.png`;
...
await writeFile('output/freight-845414/exports.json', JSON.stringify(exports, null, 2) + '\n');
